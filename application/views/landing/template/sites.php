            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-2 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        <a href="<?= base_url('')?>" class="nav-item nav-link <?= ($url == '' || $url == 'Home') ? 'active' :'' ?>">Home</a>
                        <a href="<?= base_url('About')?>" class="nav-item nav-link <?= $url == 'About' ? 'active' : '' ?>">About us</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="fw-medium" href="#">JewePe Weeding Organizer</a>, All Right Reserved.
                </div>
                </div>
            </div>
        </div>
